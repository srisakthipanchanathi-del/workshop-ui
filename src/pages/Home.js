...
// I'm using hardcoded data for now
// later this can come from the Django backend via API
const workshopData = [
  {
    title: "Python Basics",
    ...
    <div>
      ...
      <section className="hero-section">
        ...
        <p>
          ...
          Python, AI, Web Dev and more — completely free.
        </p>
        <a href="/register" className="hero-cta">Get Started</a>
      </section>
      ...
      <section className="steps-section">
        ...
        <div className="steps-row">
          <div className="step-box">
            ...
            <h4>Register</h4>
            <p>Make a coordinator account</p>
          </div>
          <div className="step-box">
            <div className="step-circle">2</div>
            <h4>Browse</h4>
            <p>Look through workshops</p>
          </div>
          <div className="step-box">
            <div className="step-circle">3</div>
            <h4>Book</h4>
            <p>Request one for your college</p>
          </div>
          <div className="step-box">
            <div className="step-circle">4</div>
            <h4>Learn</h4>
            <p>Instructor comes and teaches</p>
          </div>
        </div>
      </section>
